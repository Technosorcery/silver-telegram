...
Architecture Decision Records (ADRs) capture important architectural decisions along with their context and consequences. Full ADRs are in the [decisions/](decisions/) directory.

### 12.1 Decision Index

| ADR | Decision | Status |
|-----|----------|--------|
| [ADR-001](decisions/0001-postgresql.md) | PostgreSQL as Primary Database | Accepted |
| [ADR-002](decisions/0002-spicedb.md) | SpiceDB for Relationship-Based Authorization | Accepted |
| [ADR-003](decisions/0003-single-instance.md) | Single Instance with Scaling-Compatible Patterns | Accepted |
| [ADR-004](decisions/0004-nats-jetstream.md) | NATS + JetStream for Event Bus | Accepted |
| [ADR-005](decisions/0005-workflow-representation.md) | Workflow Representation as petgraph with JSONB Storage | Accepted |
| [ADR-006](decisions/0006-workflow-execution.md) | Workflow Execution Model | Accepted |
| [ADR-007](decisions/0007-configuration-management.md) | Centralized Configuration Management | Accepted |
